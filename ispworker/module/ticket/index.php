...
<tr>
  ...
  <td bgcolor="#ffffff">ticket / Ticketsystem</td>
</tr>
<tr>
...
<tr>
  ...
  <td bgcolor="#ffffff">
  <?
  $res = $db->query("select status from _licence where module='ticket'");
  $row = $db->fetch_array($res);
  if($row[status]=="valid") { echo "Gültig"; } else { echo "Ungültig"; }
  ?>
  - <a href="module/system/lizenzkeys.php?p=biz">Lizenzkey ändern</a>
  </td>
</tr>
<tr>
  <td bgcolor="#ffffff">Hinweise</td>
  <td bgcolor="#ffffff">module/ticket/cronwork.php als minütlichen Cronjob einrichten.</td>
</tr>
</table>
