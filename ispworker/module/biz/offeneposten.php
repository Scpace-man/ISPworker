...
include("../../header.php");
?>
<span class="htitle">Offene Posten - Statistik</span><br>
<br>
<?php
...
<td>
    <table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#ffffff">
        <form name="interval" action="module/biz/offeneposten.php" method="post">
        <tr>
            <td align="right">Intervall von:</td>
            <td><input type="text" name="from" value=""></td>
            <td width="200" rowspan="3" valign="top">Beispiel:<br> 3.2005 bis 4<br>angezeigt wird vom M&auml;rz bis April des jetzigen Jahres</td>
        </tr>
        <tr>
...
$res = $db->query("select * from biz_rechnungen where datum BETWEEN '".$datum_von."' AND '".$datum_bis."' AND (status='unbezahlt' OR status='gemahnt') order by rechnungid DESC");
