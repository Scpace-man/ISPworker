...
<?if($k->article_shellaccount_min==false) { $disabled = "DISABLED"; } else { $disabled = "onChange=\"shellaccountonchange()\""; }?>
...
<?if($k->article_cronjob_min==false) { $disabled = "DISABLED"; } else { $disabled = "onChange=\"cronjobonchange()\""; }?>
